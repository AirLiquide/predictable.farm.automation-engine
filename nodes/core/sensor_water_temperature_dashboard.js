...
module.exports = function (RED) {
    ...
    var nodeName = "sensor_water_temperature_dashboard";


    // The main node definition - most things happen in here
    function sensorWaterTemperatureDashboardNode(n) {

        var socket = require('socket.io-client')('http://127.0.0.1:80/');
        socket.on('connect', function(){
            console.log("Temperature node connected to dashboard");
        });
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, sensorWaterTemperatureDashboardNode);
