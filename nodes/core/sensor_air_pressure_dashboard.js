// node-red input binding for sensor-pressure;
...
module.exports = function (RED) {
    ...
    var nodeName = "sensor_air_pressure_dashboard";


    // The main node definition - most things happen in here
    function sensorAirPressureDashboardNode(n) {

        var socket = require('socket.io-client')('http://127.0.0.1:80/');
        socket.on('connect', function(){
            console.log("Pressure node connected to dashboard");
        });
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, sensorAirPressureDashboardNode);
