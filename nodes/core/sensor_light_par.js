// node-red input binding for sensor_light_par
...
module.exports = function(RED) {
    ...
    var nodeName = "sensor_light_par";

    // The main node definition - most things happen in here
    function sensorLightParNode(n) {
        // Create a RED node
    ...
    // Node functions.
    RED.nodes.registerType(nodeName,sensorLightParNode);
