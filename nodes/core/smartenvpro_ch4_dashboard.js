// node-red input binding for smartenvpro-ch4;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartenvpro_ch4_dashboard";


    // The main node definition - most things happen in here
    function SmartenvproCh4DashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartenvproCh4DashboardNode);
