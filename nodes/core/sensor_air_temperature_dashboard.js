...
module.exports = function (RED) {
    ...
    var nodeName = "sensor_air_temperature_dashboard";


    // The main node definition - most things happen in here
    function sensorAirTemperatureDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, sensorAirTemperatureDashboardNode);
