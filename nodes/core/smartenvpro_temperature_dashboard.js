// node-red input binding for smartenvpro-temperature;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartenvpro_temperature_dashboard";


    // The main node definition - most things happen in here
    function SmartenvproTemperatureDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartenvproTemperatureDashboardNode);
