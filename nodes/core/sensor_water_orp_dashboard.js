...
module.exports = function (RED) {
    ...
    var nodeName = "sensor_water_orp_dashboard";


    // The main node definition - most things happen in here
    function sensorWaterOrpDashboardNode(n) {

        var socket = require('socket.io-client')('http://127.0.0.1:80/');
        socket.on('connect', function(){
            console.log("ORP node connected to dashboard");
        });
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, sensorWaterOrpDashboardNode);
