// node-red input binding for smartwater-ec;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartwater_ec_dashboard";


    // The main node definition - most things happen in here
    function SmartwaterEcDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartwaterEcDashboardNode);
