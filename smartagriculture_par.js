// node-red input binding for smartagriculture_par
...
module.exports = function(RED) {
    ...
    var nodeName = "smartagriculture_par";

    // The main node definition - most things happen in here
    function SmartAgricultureParNode(n) {
        // Create a RED node
    ...
    // Node functions.
    RED.nodes.registerType(nodeName,SmartAgricultureParNode);
