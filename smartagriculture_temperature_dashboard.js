// node-red input binding for smartagriculture-temperature;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartagriculture_temperature_dashboard";


    // The main node definition - most things happen in here
    function SmartAgricultureTemperatureDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartAgricultureTemperatureDashboardNode);
