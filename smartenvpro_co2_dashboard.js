// node-red input binding for smartenvpro-co2;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartenvpro_co2_dashboard";


    // The main node definition - most things happen in here
    function SmartenvproCo2DashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartenvproCo2DashboardNode);
