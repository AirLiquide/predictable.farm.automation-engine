// node-red input binding for smartwater-humidity;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartwater_humidity_dashboard";


    // The main node definition - most things happen in here
    function SmartwaterHumidityDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartwaterHumidityDashboardNode);
