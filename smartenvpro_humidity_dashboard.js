// node-red input binding for smartenvpro-humidity;
...
module.exports = function (RED) {
    ...
    function SmartenvproHumidityDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartenvproHumidityDashboardNode);
