// node-red input binding for smartwater-temperature;
...
module.exports = function (RED) {
    ...
    var nodeName = "smartwater_temperature_dashboard";


    // The main node definition - most things happen in here
    function SmartwaterTemperatureDashboardNode(n) {
    ...
    // Node functions.
    RED.nodes.registerType(nodeName, SmartwaterTemperatureDashboardNode);
