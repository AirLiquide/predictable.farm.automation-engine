// node-red input binding for smartenvpro-pressure
...
module.exports = function(RED) {
    ...
    var nodeName = "smartenvpro_pressure";

    // The main node definition - most things happen in here
    function SmartEnvPropressureNode(n) {
        // Create a RED node
    ...
    // Node functions.
    RED.nodes.registerType(nodeName,SmartEnvPropressureNode);
